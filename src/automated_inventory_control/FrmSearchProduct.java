...
public class FrmSearchProduct extends JDialog{
	...
	public FrmSearchProduct(JFrame OwnerForm){
		...
		String StrListItem[]={"ItemNo","Description"};
		...
		public void actionPerformed(ActionEvent e){
			...
			if(srcObj=="search"){
				if(JTFSearchFor.getText().equals("")){
					...
					FrmProduct.reloadRecord("SELECT * FROM Item WHERE " + JCSearchIn.getSelectedItem().toString().replaceAll(" ", "") + " LIKE '%" + JTFSearchFor.getText() + "%' ORDER BY Description ASC");
					dispose();
				}
