...
public class FrmExpenses extends JInternalFrame{
	...
	public FrmExpenses(Connection srcCN,JFrame getParentFrame) throws SQLException{
		//Set the form caption and some properties start
		super("Expenses Records",false,true,false,true);
		...
		strSQL = "SELECT * FROM Expense  ORDER BY ExpenseIndex ASC";
